...
#### Bug Fix
* fix: resource event fill vpc with raw value [#9813](https://github.com/deepflowio/deepflow/pull/9813) by [lzf575](https://github.com/lzf575)
* fix: modify event tag missing [#9810](https://github.com/deepflowio/deepflow/pull/9810) by [ZhengYa-0110](https://github.com/ZhengYa-0110)
...
#### NEW FEATURE
* feat: Treat truncated mysql responses as OK [#9811](https://github.com/deepflowio/deepflow/pull/9811) by [rvql](https://github.com/rvql)
* feat: add grpc streaming enabled [#9802](https://github.com/deepflowio/deepflow/pull/9802) by [yuanchaoa](https://github.com/yuanchaoa)
