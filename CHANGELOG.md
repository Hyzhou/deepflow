...
#### Bug Fix
* fix: agent - eBPF Fix failure to load kfunc bytecode [#9611](https://github.com/deepflowio/deepflow/pull/9611) by [yinjiping](https://github.com/yinjiping)
...
#### NEW FEATURE
* feat: add inline func [#9653](https://github.com/deepflowio/deepflow/pull/9653) by [yuanchaoa](https://github.com/yuanchaoa)
