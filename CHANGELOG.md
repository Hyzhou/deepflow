...
#### Bug Fix
* fix(agent): add bounds checking before bytes::read_* calls in RocketMQ parser [#11121](https://github.com/deepflowio/deepflow/pull/11121) by [kylewanginchina](https://github.com/kylewanginchina)
* fix: lua compile error in close source [#11078](https://github.com/deepflowio/deepflow/pull/11078) by [qlndzt](https://github.com/qlndzt)
...
#### NEW FEATURE
* feat: add agent group config get all api [#11117](https://github.com/deepflowio/deepflow/pull/11117) by [ZhengYa-0110](https://github.com/ZhengYa-0110)
