...
#### Bug Fix
* fix: vtap exceptions type [#9597](https://github.com/deepflowio/deepflow/pull/9597) by [askyrie](https://github.com/askyrie)
...
#### NEW FEATURE
* feat: optimizes the robustness of huawei token processing [#9594](https://github.com/deepflowio/deepflow/pull/9594) by [ZhengYa-0110](https://github.com/ZhengYa-0110)
* feat: opt otel data policy queries [#9588](https://github.com/deepflowio/deepflow/pull/9588) by [yuanchaoa](https://github.com/yuanchaoa)
* feature: add new vtap exception [#9571](https://github.com/deepflowio/deepflow/pull/9571) by [askyrie](https://github.com/askyrie)
