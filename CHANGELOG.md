...
#### Bug Fix
* fix(java): improve socket lifecycle handling for connect/send/close [#11760](https://github.com/deepflowio/deepflow/pull/11760) by [yinjiping](https://github.com/yinjiping)
