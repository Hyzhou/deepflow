...
#### Bug Fix
* fix: genesis sync aging data failed [#10270](https://github.com/deepflowio/deepflow/pull/10270) by [askyrie](https://github.com/askyrie)
...
#### NEW FEATURE
* feat: improves the performance of query processes [#10267](https://github.com/deepflowio/deepflow/pull/10267) by [ZhengYa-0110](https://github.com/ZhengYa-0110)
