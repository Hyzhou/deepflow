...
#### Bug Fix
* fix: the rrt of the logs and metrics is inconsistent [#10025](https://github.com/deepflowio/deepflow/pull/10025) by [yuanchaoa](https://github.com/yuanchaoa)
...
#### NEW FEATURE
* feat: agent - eBPF Obtain the mount point for file (#10057) [#10098](https://github.com/deepflowio/deepflow/pull/10098) by [yinjiping](https://github.com/yinjiping)
* feat: profile.in_process add 1s materialized view [#10083](https://github.com/deepflowio/deepflow/pull/10083) by [lzf575](https://github.com/lzf575)
