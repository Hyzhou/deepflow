...
#### Bug Fix
* fix(eBPF): Flush symbol cache after replay to avoid unsent data [#11735](https://github.com/deepflowio/deepflow/pull/11735) by [yinjiping](https://github.com/yinjiping)
...
#### NEW FEATURE
* feat: encrypt agent cmd content [#11738](https://github.com/deepflowio/deepflow/pull/11738) by [ZhengYa-0110](https://github.com/ZhengYa-0110)
* feat: add mem exceeded exception [#11737](https://github.com/deepflowio/deepflow/pull/11737) by [yuanchaoa](https://github.com/yuanchaoa)
