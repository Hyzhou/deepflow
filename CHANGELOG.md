...
#### Bug Fix
* fix: move existsed trace infos to attributes [#10516](https://github.com/deepflowio/deepflow/pull/10516) by [taloric](https://github.com/taloric)
...
#### NEW FEATURE
* feat: agent - eBPF Avoid flooding the process event logs [#10515](https://github.com/deepflowio/deepflow/pull/10515) by [yinjiping](https://github.com/yinjiping)
