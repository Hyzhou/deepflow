...
#### Bug Fix
* Revert "fix: dedicated vtap func" [#10596](https://github.com/deepflowio/deepflow/pull/10596) by [askyrie](https://github.com/askyrie)
...
#### NEW FEATURE
* feat: eBPF Bind mount type observes based on the container [#10592](https://github.com/deepflowio/deepflow/pull/10592) by [yinjiping](https://github.com/yinjiping)
