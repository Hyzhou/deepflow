...
#### Bug Fix
* fix: Agent config change TODOs vol.5 [#8632](https://github.com/deepflowio/deepflow/pull/8632) by [rvql](https://github.com/rvql)
* fix: Agent config change TODOs vol.4 [#8625](https://github.com/deepflowio/deepflow/pull/8625) by [rvql](https://github.com/rvql)
...
#### NEW FEATURE
* feat: agent - eBPF Supplementary explanation for `template.yaml` [#8635](https://github.com/deepflowio/deepflow/pull/8635) by [yinjiping](https://github.com/yinjiping)
